 ...
 */
package de.unimannheim.wdi.solution;
...
/**
 * {@link AttributeValueFuser} for the titles of {@link Books}s.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class TitleFuserLongestString extends AttributeValueFuser<String, Books, Attribute> {
	...
	public void fuse(RecordGroup<Books, Attribute> group, Books fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		// add provenance info
		fusedRecord.setAttributeProvenance(Books.TITLE, fused.getOriginalIds());
	}

	@Override
	public boolean hasValue(Books record, Correspondence<Attribute, Matchable> correspondence) {
		return record.hasValue(Books.TITLE);
	}
