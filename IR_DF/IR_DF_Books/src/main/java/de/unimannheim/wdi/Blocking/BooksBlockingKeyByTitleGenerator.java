...
package de.unimannheim.wdi.Blocking;
...
/**
 * {@link BlockingKeyGenerator} for {@link Books}s, which generates a blocking
 * key based on the title
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class BooksBlockingKeyByTitleGenerator extends
		RecordBlockingKeyGenerator<Books, Attribute> {
