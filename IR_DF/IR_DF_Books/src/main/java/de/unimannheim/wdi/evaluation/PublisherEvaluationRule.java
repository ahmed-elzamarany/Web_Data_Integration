...
/**
 * {@link EvaluationRule} for the directors of {@link Books}s. The rule simply
 * compares the director of two {@link Books}s and returns true, in case they
 * are identical.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class PublisherEvaluationRule extends EvaluationRule<Books, Attribute> {
